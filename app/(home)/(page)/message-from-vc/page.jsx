      ...
      <div className="py-8 lg:py-16 px-4 mx-auto ">
        <div className="bg-white p-5 rounded-lg shadow-lg shadow-gray-500">
          ...
          <div className="grid grid-cols-12 justify-center  relative">
            ...
            <div className="justify-center items-start col-span-3 place-items-center">
              <div className="relative">
                <Image
                  className="w-full h-full object-cover bg-green-100 p-2 border border-slate-200 shadow-md rounded-md"
                  src={msgFromVc.image || '/placeholder.png'}
                  alt=""
